...
async function main() {
    ...
    try {
        ...
        const stats = {
            ...
            totalRuns: (JSON.parse(fs.readFileSync(statsFile, 'utf8')).totalRuns || 0) + 1,
            totalSuccess: (JSON.parse(fs.readFileSync(statsFile, 'utf8')).totalSuccess || 0) + successful,
            totalFailed: (JSON.parse(fs.readFileSync(statsFile, 'utf8')).totalFailed || 0) + (total - successful)
        };
